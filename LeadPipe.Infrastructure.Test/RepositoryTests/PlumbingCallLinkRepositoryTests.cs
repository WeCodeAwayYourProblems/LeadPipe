...
public class PlumbingCallLinkRepositoryTests
{
    ...
    public async Task AddRangeAsync_ShouldAddMultipleEntities()
    {
        ...
        {
            new() { Id = 1, PlumbingEntity = new(), CallEntity = new() },
            new() { Id = 2, PlumbingEntity = new(), CallEntity = new() }
        };
    ...
    public async Task AddAsync_ShouldAddPlumbingCallLink()
    {
        ...
        var plumbing = new PlumbingCallLink { Id = 1, PlumbingEntity = new(), CallEntity = new() };
    ...
    {
        var context = RepoTestHelpers.GetInMemoryContext();
        context.PlumbingCallLinks.Add(new PlumbingCallLink { Id = 1, PlumbingEntity = new(), CallEntity = new() });
    ...
    public async Task UpdateValuesAsync_ShouldUpdateEntity()
    {
        ...
        var repo = new PlumbingCallLinkRepository(context);
        var updatedPlumbingCallLink = new PlumbingCallLink { Id = 1, PlumbingEntity = new(), CallEntity = new() };
    ...
    {
        var repo = new PlumbingCallLinkRepository(RepoTestHelpers.GetInMemoryContext());
        var updatedPlumbingCallLink = new PlumbingCallLink { Id = 99, PlumbingEntity = new(), CallEntity = new() };
